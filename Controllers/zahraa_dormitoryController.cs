...
{
    public class zahraa_dormitoryController : Controller
    {
        ...
        public zahraa_dormitoryController(InterfaceSystemWebDorms<TransInnerDormDoubleRoom> _ListTransInnerDormDoubleRoom,
